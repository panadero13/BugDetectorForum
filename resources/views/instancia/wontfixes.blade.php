...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h1>{{ __('Lista de Instancias con estado Wontfix') }}</h1></div>
                <div class="card-body">
                    ...
                    <div class="card" style="width: 100%;">
                        <div class="card-body">
                            ...
                            <a href="/marcarComoPendiente/{{$instancia->id}}" class="btn btn-info">Marcar como Pendiente</a>
                            @endif
                            @endif
                        </div>
                    </div>
